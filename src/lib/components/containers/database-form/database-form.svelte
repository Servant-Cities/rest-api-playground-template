<script lang="ts">
	...
	let { data }: { data: { form: SuperValidated<Infer<DatabaseEditorSchema>>, tenant: {db: string} } } = $props();
...
<form method="POST" use:enhance class="w-full">
	...
	<Button type="button" onclick={downloadJson} class="ml-4 px-4 py-2 rounded">Export</Button>
</form>
